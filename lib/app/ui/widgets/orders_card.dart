                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        buildTitle(text: "Order Id"),
                        buildTitle(text: "Customer Name"),
                        buildTitle(text: "Customer Phone"),
                        buildTitle(text: "Product Name"),
                        buildTitle(text: "Status"),
                    ...
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        buildValue(text: "GRO1"),
                        buildValue(text: "testcustomer"),
                        buildValue(text: "1234567894"),
                        buildValue(text: "Green Chilli"),
                        buildValue(text: "Delivered"),
                        buildValue(text: "Rs 150"),
                      ],
                    ),
                    SizedBox(width: 5),
                  ],
